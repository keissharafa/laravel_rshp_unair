            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.dokter.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="bidang_dokter" class="form-control @error('bidang_dokter') is-invalid @enderror" value="{{ old('bidang_dokter') }}" placeholder="Contoh: Umum, Bedah" required>
